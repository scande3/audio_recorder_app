...
import StimulusReflex from "@hotwired/stimulus_reflex"
...
export default class extends Controller {
  ...
  startRecording(event) {
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      alert("Your browser does not support audio recordings, please use a different browser or update your current browser")
    }
  }
